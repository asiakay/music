...
songIndex = 0;
songs = ['./assets/music/asialakay_help-the-helpless-prod-by-kid-hum.mp3', './assets/music/123trackMNMLRGNL.mp3', './assets/music/Orphine.mp3']; // object storing paths for audio objects
...
songTitles = ["Prayer for the helpless", "MNMLRGNL X Jay-Z", "SCALA"]; // object storing track titles
